...
int sensor_pins_left[3] = {PA0, PA1, PA2}; // left back, middle, front
...
int stdMotorSpeedsLTR[4] = {(200)*3, (-187)*3, (-143)*4-20, (180)*4+10};  // 0, 1, 2, 3
...
int slowMotorSpeedsRTL[4] = {int(-195+10)*3, int(187+10)*3, int(143*3), int(-177*3)}; // TODO: change to correct values
