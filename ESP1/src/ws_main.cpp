...
// void loop() {
//   // wsSend("moveR " + String(moveR) + " moveY " + String(moveY) + " moveZ " + String(moveZ));
//   if (moveR != 1) {
...
// void loop() {
//   if (!done) {
//     done = craneMoveRB(0); // to position 0
//   }
// }
