...
int RMOTOR_BACK_FORWARD_PIN = 11;
int RMOTOR_BACK_BACKWARD_PIN = 10;
int RMOTOR_BACK_ENCODER_PIN = 42; //36; // 38
int RMOTOR_BACK_ENCODER_PIN_B = 36; // this is the weird yellow one, can use as second pin?
int RMOTOR_BACK_EXTEND_LIMIT_SWITCH_PIN = 41; 
